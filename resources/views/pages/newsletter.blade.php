...
<div class="container max-w-3xl px-4 py-16 mx-auto text-center">
    <div class="p-10 bg-card text-card-foreground border border-border shadow-xl rounded-3xl">
        ...
        <h1 class="mb-4 text-4xl font-extrabold text-foreground">Join the Shelf-e Newsletter</h1>
        <p class="mb-8 text-lg text-muted-foreground">Get the latest updates on new book releases, author interviews, and exclusive subscriber discounts directly to your inbox.</p>
        ...
        <form action="{{ route('newsletter.subscribe') }}" method="POST" class="flex flex-col max-w-lg gap-3 mx-auto sm:flex-row sm:justify-center">
            ...
            <div class="flex-1 w-full">
                <input type="email" name="email" placeholder="Enter your email address" class="w-full px-4 py-3 bg-background border @error('email') border-red-500 @else border-input @enderror rounded-xl focus:ring-2 focus:ring-ring focus:outline-none text-foreground" required>
