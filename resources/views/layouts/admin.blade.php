...
{{-- V2 Links --}}
                ...
                <a href="{{ route('admin.scraper.index') }}" class="flex items-center px-4 py-3 font-medium transition rounded-lg {{ request()->routeIs('admin.scraper.*') ? 'bg-gray-100 text-gray-900 font-semibold' : 'text-gray-500 hover:bg-gray-100 hover:text-gray-900' }}">
