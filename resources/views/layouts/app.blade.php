            ...
            <div class="container grid grid-cols-1 gap-12 px-4 mx-auto md:grid-cols-4">
                ...
                <div id="contact">
                    ...
                    <ul class="space-y-3 text-sm text-gray-500">
                        ...
                        <li class="flex items-center"><svg class="w-4 h-4 mr-3 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg> <a href="mailto:info@shelfebd.com" class="hover:text-gray-900 transition-colors">info@shelfebd.com</a></li>
