@if($reviews->isEmpty())
    <div class="flex flex-col items-center justify-center py-20 bg-card text-card-foreground border border-border rounded-2xl shadow-sm">
...
@else
    <div class="space-y-4">
        ...
        <div class="bg-card text-card-foreground border border-border rounded-2xl shadow-sm p-6">
