        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea id="bio" name="bio" rows="5"
                          ...
                          class="block w-full px-4 py-3 text-sm placeholder-gray-400 transition-all border-gray-200 rounded-lg shadow-sm bg-gray-50 focus:border-cyan-500 focus:ring-cyan-500">{{ old('bio') }}</textarea>
            </div>
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-400">JPEG, PNG, or WebP. Max 2 MB.</p>
            </div>
