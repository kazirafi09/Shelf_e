...
<div class="flex items-center justify-center min-h-[calc(100vh-200px)] py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md p-8 space-y-8 bg-white border border-gray-100 shadow-2xl rounded-3xl md:p-10 ring-1 ring-gray-900/5">
        ...
        <div class="text-center">
            ...
            <p class="mt-3 text-sm text-gray-500">Sign in to your account to continue</p>
        </div>
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ show: false }">
                        ...
                        <input id="password" :type="show ? 'text' : 'password'" name="password" placeholder="••••••••" required class="block w-full py-3.5 pl-11 pr-12 text-sm placeholder-gray-400 transition-colors border-gray-200 rounded-xl shadow-sm bg-gray-50 focus:bg-white focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20" />
            ...
            <div class="flex items-center justify-between">
                <label class="flex items-center cursor-pointer group">
                    <div class="relative flex items-center justify-center w-5 h-5">
                        <input type="checkbox" name="remember" class="w-full h-full transition-colors border-gray-300 rounded cursor-pointer text-cyan-600 focus:ring-cyan-500/30 group-hover:border-cyan-500">
                    </div>
                    <span class="ml-2 text-sm font-medium text-gray-600 transition-colors group-hover:text-gray-900">Remember me</span>
                </label>
