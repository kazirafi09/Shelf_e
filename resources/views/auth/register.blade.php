...
<div class="flex items-center justify-center min-h-[calc(100vh-200px)] py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md p-8 space-y-8 bg-card text-card-foreground border border-border shadow-2xl rounded-3xl md:p-10">
        ...
        <a href="{{ route('auth.google') }}"
           class="flex items-center justify-center w-full gap-3 px-6 py-3.5 mt-4 text-sm font-semibold transition-all bg-white border border-gray-300 rounded-xl text-gray-700 shadow-sm hover:bg-gray-50 hover:shadow-md hover:-translate-y-0.5 active:translate-y-0 active:scale-95">
